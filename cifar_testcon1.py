...
parser.add_argument(
    '--droprate', default=0.2, type=float, help='Dropout probability')
# AugMix options
parser.add_argument(
    '--mixture-width',
    default=3,
...
parser.add_argument(
    ...
    default='SGD',
    choices=['SGD','AdamW'],
    help='Chose different way to test network , SGD with lambda schedule or Adamw with consineline schedule.')
parser.add_argument(
    '--schedule',
    '-sch',
    type= str,
    default='Lam',
    choices=['Lam','Cos'],
    help='Chose different way to test network , lambda schedule or consineline schedule.')
parser.add_argument(
    '--pretrained',
    '-pt',
    action='store_true',
    help=' pretain a module')
...
#define network train way , a:sgd optimizer with lambda schedule
                            # b:Adamw optimizer with CosineAnnealingLR schedule
  ...
  for epoch in range(start_epoch, args.epochs):
    ...
    writer.add_scalar('convnext-train_loss', train_loss_ema, epoch)
    writer.add_scalar('convnext-test_loss', test_loss, epoch)
    writer.add_scalar('convnext-test_acc', test_acc, epoch)
