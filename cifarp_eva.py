...
parser.add_argument('--pretrained', '-pt',action='store_true',help='deciside the network pretrained or not')
...
# Checkpoints
parser.add_argument('--save', '-s', type=str, default='./EVA/', help='Folder to save checkpoints.')
parser.add_argument('--resume', '-r', type=str, default='/work/ws-tmp/g060677-Cc/augmix-master1/resnet18/npt-a', help='Checkpoint path to resume / test.')
...
c_p_dir = '/work/ws-tmp/g060677-Cc/augmix-master1/data/cifar/' + c_p_dir
